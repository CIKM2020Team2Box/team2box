...
class ExpertsEmbeding:        
    def __init__(self,hsize,data):        
        ...
        self.teamcenters=np.loadtxt(self.dataset+"/krnmdata1/teamsembeding.txt")
        print(self.teamcenters)
        self.teamoffsets=np.loadtxt(self.dataset+"/krnmdata1/teamsOffsets.txt")
        print(self.teamoffsets)
        
        
        # load expert best team
        gfile=open(self.dataset+"/krnmdata1/ExpertBestQuetionAnswer.txt")        
        gfile.readline()
    ...
    def run(self,walklen):
        ...
        loss_total=0
        train_len=len(pairs)
        logfile=open(self.dataset+"/krnmdata1/ExpertsEmbedinglog2_.txt","w")
    ...
    def save_embeddings(self,i):
        ...
        w1=self.W1.numpy()
        w2=self.W2.numpy()
        np.savetxt(self.dataset+"/krnmdata1/expert_question_w1_embedding2_"+str(i)+".txt",w1, fmt='%f')
        np.savetxt(self.dataset+"/krnmdata1/expert_question_w2_embedding2_"+str(i)+".txt",w2, fmt='%f')
...
ob2=ExpertsEmbeding(32,dataset[0])
#ob2=ExpertsEmbeding(dataset[0])
ob2.run(9)
#ob2.save_embeddings()